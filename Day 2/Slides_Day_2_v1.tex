...
\hlstd{graph} \hlkwb{<-}
  \hlkwd{create_graph}\hlstd{()} \hlopt{%>%}
  \hlkwd{add_global_graph_attrs}\hlstd{(}\hlstr{"graph"}\hlstd{,} \hlstr{"rankdir"}\hlstd{,} \hlstr{"LR"}\hlstd{)} \hlopt{%>%}
  \hlkwd{add_node}\hlstd{(}\hlkwc{label}\hlstd{=}\hlstr{"Wealth"}\hlstd{)} \hlopt{%>%} \hlkwd{add_node}\hlstd{(}\hlkwc{label}\hlstd{=}\hlstr{"Democracy"}\hlstd{)}
\hlkwd{render_graph}\hlstd{(graph)}
\end{alltt}
\end{kframe}
...
\hlstd{graph} \hlkwb{<-}
  \hlkwd{create_graph}\hlstd{()} \hlopt{%>%}
  \hlkwd{add_global_graph_attrs}\hlstd{(}\hlstr{"graph"}\hlstd{,} \hlstr{"rankdir"}\hlstd{,} \hlstr{"LR"}\hlstd{)} \hlopt{%>%}
  \hlkwd{add_node}\hlstd{(}\hlkwc{label}\hlstd{=}\hlstr{"Wealth"}\hlstd{)} \hlopt{%>%} \hlkwd{add_node}\hlstd{(}\hlkwc{label}\hlstd{=}\hlstr{"Democracy"}\hlstd{)} \hlopt{%>%} \hlkwd{add_edge}\hlstd{(}\hlkwc{from}\hlstd{=}\hlstr{"Wealth"}\hlstd{,}\hlkwc{to}\hlstd{=}\hlstr{"Democracy"}\hlstd{,} \hlkwc{edge_aes}\hlstd{=}\hlkwd{edge_aes}\hlstd{(}\hlkwc{color}\hlstd{=}\hlstr{"black"}\hlstd{))}
\hlkwd{render_graph}\hlstd{(graph)}
\end{alltt}
\end{kframe}
...
\hlstd{graph} \hlkwb{<-}
  \hlkwd{create_graph}\hlstd{()} \hlopt{%>%}
  \hlkwd{add_global_graph_attrs}\hlstd{(}\hlstr{"graph"}\hlstd{,} \hlstr{"rankdir"}\hlstd{,} \hlstr{"LR"}\hlstd{)} \hlopt{%>%}
  \hlkwd{add_node}\hlstd{(}\hlkwc{label}\hlstd{=}\hlstr{"Wealth"}\hlstd{)} \hlopt{%>%} \hlkwd{add_node}\hlstd{(}\hlkwc{label}\hlstd{=}\hlstr{"Democracy"}\hlstd{)} \hlopt{%>%} \hlkwd{add_edge}\hlstd{(}\hlkwc{from}\hlstd{=}\hlstr{"Democracy"}\hlstd{,}\hlkwc{to}\hlstd{=}\hlstr{"Wealth"}\hlstd{,} \hlkwc{edge_aes}\hlstd{=}\hlkwd{edge_aes}\hlstd{(}\hlkwc{color}\hlstd{=}\hlstr{"black"}\hlstd{))}
\hlkwd{render_graph}\hlstd{(graph)}
\end{alltt}
\end{kframe}
...
\hlstd{graph} \hlkwb{<-}
  \hlkwd{create_graph}\hlstd{()} \hlopt{%>%}
  \hlkwd{add_global_graph_attrs}\hlstd{(}\hlstr{"graph"}\hlstd{,} \hlstr{"rankdir"}\hlstd{,} \hlstr{"LR"}\hlstd{)} \hlopt{%>%}
  \hlkwd{add_node}\hlstd{(}\hlkwc{label}\hlstd{=}\hlstr{"Wealth"}\hlstd{)} \hlopt{%>%} \hlkwd{add_node}\hlstd{(}\hlkwc{label}\hlstd{=}\hlstr{"Democracy"}\hlstd{)} \hlopt{%>%} \hlkwd{add_node}\hlstd{(}\hlkwc{label}\hlstd{=}\hlstr{"European"}\hlstd{)} \hlopt{%>%} \hlkwd{add_edge}\hlstd{(}\hlkwc{from}\hlstd{=}\hlstr{"European"}\hlstd{,} \hlkwc{to}\hlstd{=}\hlstr{"Wealth"}\hlstd{)} \hlopt{%>%} \hlkwd{add_edge}\hlstd{(}\hlkwc{from}\hlstd{=}\hlstr{"European"}\hlstd{,} \hlkwc{to}\hlstd{=}\hlstr{"Democracy"}\hlstd{)}
\hlkwd{render_graph}\hlstd{(graph)}
\end{alltt}
\end{kframe}
...
\hlstd{graph} \hlkwb{<-}
  \hlkwd{create_graph}\hlstd{()} \hlopt{%>%}
  \hlkwd{add_global_graph_attrs}\hlstd{(}\hlstr{"graph"}\hlstd{,} \hlstr{"rankdir"}\hlstd{,} \hlstr{"LR"}\hlstd{)} \hlopt{%>%}
  \hlkwd{add_node}\hlstd{(}\hlkwc{label}\hlstd{=}\hlstr{"Wealth"}\hlstd{)} \hlopt{%>%} \hlkwd{add_node}\hlstd{(}\hlkwc{label}\hlstd{=}\hlstr{"Democracy"}\hlstd{)} \hlopt{%>%} \hlkwd{add_node}\hlstd{(}\hlkwc{label}\hlstd{=}\hlstr{"Selected Cases"}\hlstd{)} \hlopt{%>%} \hlkwd{add_edge}\hlstd{(}\hlkwc{from}\hlstd{=}\hlstr{"Wealth"}\hlstd{,}\hlkwc{to}\hlstd{=}\hlstr{"Selected Cases"}\hlstd{,} \hlkwc{edge_aes}\hlstd{=}\hlkwd{edge_aes}\hlstd{(}\hlkwc{color}\hlstd{=}\hlstr{"black"}\hlstd{))} \hlopt{%>%} \hlkwd{add_edge}\hlstd{(}\hlkwc{from}\hlstd{=}\hlstr{"Democracy"}\hlstd{,}\hlkwc{to}\hlstd{=}\hlstr{"Selected Cases"}\hlstd{,} \hlkwc{edge_aes}\hlstd{=}\hlkwd{edge_aes}\hlstd{(}\hlkwc{color}\hlstd{=}\hlstr{"black"}\hlstd{))}
\hlkwd{render_graph}\hlstd{(graph)}
\end{alltt}
\end{kframe}

...
2. If our theory is correct, we should *only* find an effect at the threshold (distance=0). Use the 'RDestimate' function (in the 'rdd' library) to perform **placebo tests** with the threshold set to distance=0.1,-0.1,0.05 and -0.05. What do we learn from this test?

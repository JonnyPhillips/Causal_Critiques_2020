...
The following are observational studies that have been conducted by political scientists. Propose an alternative methodology (an experiment or natural experiment) that might support a more convincing causal argument in each context, and describe the assumptions required for the methodology to be successful:

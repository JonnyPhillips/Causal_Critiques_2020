...
*Lab Exercise:* We use our judgment of the relevance and generalizability of study findings to draft policy advice on how governments should respond to a paper's conclusions. 

*Lab Replication Exercise:* We conduct robustness checks and sensitivity analysis of the data and findings in key studies using Stata/R.

## Morning

1. [Lecture Slides](https://jonnyphillips.github.io/Causal_Critiques_2020/Day 4/Slides_Day_4_v1.pdf)
